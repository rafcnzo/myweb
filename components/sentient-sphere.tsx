...
function Sphere() {
  ...
  const vertexShader = `
    ...
    void main() {
      ...
      // Multi-layer noise: low freq besar + mid + high detail
      float n1 = snoise(position * 0.8 + uTime * 0.12);          // bentuk kasar utama
      float n2 = snoise(position * 1.8 - uTime * 0.09) * 0.5;   // medium
      float n3 = snoise(position * 3.5 + uTime * 0.2)  * 0.25;  // detail kecil
      
      float displacement = (n1 + n2 + n3) * 0.45;
